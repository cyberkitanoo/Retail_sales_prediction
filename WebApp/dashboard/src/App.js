...
function App() {
  ...
  return (
    ...
    <Layout className="site-layout-background" style={{ padding: '24px 0' }}>
      <Sider style={{background: 'rgb(64, 64, 65)',
        overflow: 'auto',
        height: '100vh',
        position: 'fixed',
        left: 0,
    ...
    <Header className="site-layout-background" style={{background:'rgb(64, 64, 65)',  padding: 0, fontSize:35}}>
    ...
    <Title>WELCOME TO RETAIL SALES :)</Title>
      ...
      <Title level={3} style={{color:"white"}}>Choose an Option</Title>

      <Button type="dashed" style={{background:'rgb(64, 64, 65)',fontSize:20}}><a href="/about" style={{color:"white"}} >  Check your <br />   Customer Details   </a> </Button>
      ....
      <Button type="dashed" style={{background:'rgb(64, 64, 65)',fontSize:20}}><a href="/about" style={{color:"white"}} >  Check your <br />  Product Details  </a></Button>
      ....
      <Button type="dashed" style={{background:'rgb(64, 64, 65)',fontSize:20}}><a href="/about" style={{color:"white"}} >  Check your <br />  Sales Data  </a></Button>
      <span class="tab"></span>
      ....
      <Button type="dashed" style={{background:'rgb(64, 64, 65)',fontSize:20}}><a href="/about" style={{color:"white"}} >  Check your <br /> Reports  </a></Button><br /><br /><br /><br />
      
      <p style={{fontSize:25, color:"white"}}>In today’s world maintaining large records in any company is a very tedious and time consuming task.<br />
